...
\centering
\includegraphics[width=\textwidth]{mainChartlinear.png}
...
\begin{subfigure}{0.98\textwidth}
\centering
\includegraphics[width=\textwidth]{mainChartlog.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.96\textwidth]{memoryChart.png}
\caption{Effect of fractional order on the infected population $I(t)$.}
\label{fig:memory_infected}
\end{figure}

Figure~\ref{fig:memory_infected} compares the infected population for $q=1.00$, $q=0.95$, $q=0.85$, and $q=0.75$. All four curves begin from the same initial infected population, but the rate of decline differs. The ordinary model with $q=1.00$ decreases fastest, while the lower fractional order $q=0.75$ decreases slowest and remains highest at the final time. This confirms the role of fractional memory: smaller values of $q$ create stronger memory effects and delay the movement of the system toward the disease-free state.

\begin{figure}[H]
\centering
\begin{subfigure}{0.98\textwidth}
\centering
\includegraphics[width=\textwidth]{memoryAChart.png}
\caption{AIDS-stage population $A(t)$ for different fractional orders.}
...
\begin{subfigure}{0.98\textwidth}
\centering
\includegraphics[width=\textwidth]{memoryPhaseChart.png}
\caption{Memory-effect phase trajectory comparing $I(t)$ and $T(t)$.}
...
\begin{subfigure}{0.98\textwidth}
\centering
\includegraphics[width=\textwidth]{mittagChart.png}
\caption{Mittag--Leffler memory kernel compared with the ordinary exponential case.}
\label{fig:mittag_kernel}
\end{subfigure}
\caption{Additional memory-effect visualisations for AIDS progression, phase behaviour, and the fractional memory kernel.}
\label{fig:memory_extra}
\end{figure}

Figure~\ref{fig:memory_extra} gives additional evidence of the effect of the fractional order. In Figure~\ref{fig:memory_aids}, the AIDS-stage population first increases slightly and then decreases over time. The curve for the lower fractional order $q=0.75$ remains higher for longer, while the ordinary case $q=1.00$ decreases faster. This means that stronger memory effects can delay the reduction of the AIDS-stage population.
