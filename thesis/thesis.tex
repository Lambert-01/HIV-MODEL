...
with Social Behaviour Interventions}\\[12pt]
...
The main aim of this report is to formulate, analyse, and computationally simulate a fractional-order SITA model of HIV transmission incorporating social behaviour interventions and special functions.
...
The literature shows that compartmental HIV models are useful, fractional derivatives can represent memory effects, and special functions provide the mathematical foundation for fractional models. However, there remains room for a model that combines fractional-order HIV dynamics with social behaviour interventions and a computational dashboard. This report addresses that gap.
